...
public class IzvozTroskova extends TroskovnikActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.izvoz_troskova);
        ...
        for (int i = 0; i < troskovi.size(); i++) {
            data = troskovi.get(i);
            csv += ( data.naziv_troska + "," + data.vrsta_troska + "," + String.valueOf(data.iznos)+ "," + data.datum + "\n");
        }
    ...
    public void openFolder() {
      ...
      //  intent.putExtra("return-data", csv);
